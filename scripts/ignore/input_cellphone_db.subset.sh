...
columns=1,$( for (( ii=2; ii<=100; ii++ )); do echo $ii; done | sort -R | head -10 | sort -n | tr '\n' ',' | sed 's/,$//' ) 
...
echo $columns > /oak/stanford/groups/smontgom/amarder/t21-proj/out/full/cpdb_Data/10X_DownSyndrome_Liver.fields.out
xargs cut --fields=${columns} /oak/stanford/groups/smontgom/amarder/t21-proj/out/full/cpdb_Data/10X_DownSyndrome_Liver.norm_count.txt > /oak/stanford/groups/smontgom/amarder/t21-proj/out/full/cpdb_Data/10X_DownSyndrome_Liver.norm_count.sub.txt
