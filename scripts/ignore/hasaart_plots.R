...
res = fread("/Users/andrewmarderstein/Documents/Research/t21_multiome/output/data/hasaart_et_al_2020_scirep/out/D21.snv_enrich.txt",data.table = F,stringsAsFactors = F)
