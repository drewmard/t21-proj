...
system(paste0("rm -r ",dir,"/output/data/",DATASET,"/081822_clust"))
system(paste0("mkdir -p ",dir,"/output/data/",DATASET,"/081822_clust"))
...
f.out <- paste0(dir,"/output/data/",DATASET,"/RNA_dotplot.final_v3.pdf")
