...
# fout="/oak/stanford/groups/smontgom/amarder/t21/out/10X_Healthy_Liver.umap.h5ad"
# adata.write(fout)
...
fc.plotUMAP(adata, variable="leiden", palette=myColors, components=["1,2"], pdf=pdf)
