...
sc.pp.neighbors(adata_paga,
            n_pcs=adata_paga.obsm["X_rna_harmony"].shape[1],
            use_rep="X_rna_harmony",
            knn=True,
            random_state=42,
            method='umap',
            metric='euclidean')
...
os.chdir(outDir)
f_out=".RNA.PAGA_raw_graph_harmony.png"
...
f_out2=".RNA.PAGA_trajectory_embedding_harmony.png"
...
f, axs = plt.subplots(1,1,figsize=(25,30))
f_out3=".RNA.PAGA_diffusion_pseudotime_harmony.png".format(idtype)
# sc.pl.draw_graph(adata_paga,
...
f_out4="{0}/figures/RNA.PAGA_Mean_Pseudotimes_harmony.pdf".format(outDir)
...
f_out5="{0}/figures/RNA.PAGA_connections_harmony.pdf".format(outDir)
...
f_out=".RNA.PAGA_raw_graph_harmony2.png"
sc.pl.paga(adata_paga, threshold=threshold, node_size_scale=0.8, edge_width_scale=0.3, fontsize=5, save=f_out)


f_df_out = "/oak/stanford/groups/smontgom/amarder/neuro-variants/output/data/DS_Multiome_h_v2/Multiome.RNA_only2.h.paga.h5ad"
