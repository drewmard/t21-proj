...
# first, we are going to read in femur data, and plan to downsample the liver to that size:
...
########################################################################################################
# next, we are going to read in Liver data, for working with that dataset
